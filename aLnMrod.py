...
async def bh(event):
    if ispay2[0] == "yes":
        ...
        c = str(msg[1])
        choice = str(msg[0])
        await event.edit(f"تم بدأ الصيد .! قناة السورس @IRTHON")
                ...
                if "Available" in isav:
                    try:
                        await a(functions.account.UpdateUsernameRequest(
                            username=username))
                        trys += 1
                        await a.send_file(event.chat_id, 'https://telegra.ph/file/6bd6a1cde2b1a9f2256f7.mp4', caption=f'''the Leader : @Q44UU
User ⤷ @{username} 
Save ⤷ account
Clicks ⤷ {trys}
turbo ⤷ @IRTHON
''')
                        await a.send_file("i5tbot", 'https://telegra.ph/file/6bd6a1cde2b1a9f2256f7.mp4', caption=f'''the Leader : @Q44UU
User ⤷ @{username}
Save ⤷ account
Clicks ⤷ {trys}
turbo ⤷ @IRTHON
